      ...
      <div id="invoice-document" className="rounded-2xl overflow-hidden"
        ...
        <div className="px-10 py-8 flex items-start justify-between"
          ...
          <div className="text-right">
            <p className="text-3xl font-black tracking-tight" style={{ fontFamily: "var(--font-display)" }}>INVOICE</p>
            <p className="text-lg font-mono font-bold opacity-90 mt-0.5">{invoice.invoiceNumber}</p>
          </div>
        </div>
